 ...
 * г. Минск, 2020
 *
 * Задание 6, 7. (Тема: ООП, Калькулятор)
 * 1. Создать класс CalculatorWithMathExtends, все методы в данном классе НЕ статические.
 *    В классе CalculatorWithMathExtends должны присутствовать:
 *    1.1. 4 метода (деления, умножение, вычитание, сложение)
 *         каждый из этих методов нужно наследовать из класса CalculatorWithOperator.
 *    1.2. Методы (возведение в степень, модуль числа, корень из числа)
 *         требуется переопределить, и можно использовать только вызовы
 *         методов библиотеки Math, все методы в данном классе НЕ статические.
 *
...
public class TestCWMExtendClass {
    public static void main(String[] args) {
        CalculatorWithMathExtends calcWO = new CalculatorWithMathExtends();
