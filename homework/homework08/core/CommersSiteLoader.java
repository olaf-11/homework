 ...
 */
public abstract class CommersSiteLoader {
     ...
     */
    protected final double[] load(String urlToSite, CommersSiteLoader.Currency currencyName){
    ...
    public abstract double[] load(CommersSiteLoader.Currency currencyName);
     ...
     * @return курс который мы нашли
     */
    protected abstract double[] handle(String content, CommersSiteLoader.Currency currencyName);
}
