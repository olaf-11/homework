...
public class OlegTask12 {
    public static void main(String[] args) {
         ...
         * всего аргументов: 1,
         * значение аргумента является положительным целым числом
         * и не нулем (дополнительный метод):
         */
        if (args != null && args.length == 1 && isValidNumbers(args[0])){

            /* Переменная num -- для перевода цифры в строке args[0] из char в int.
             * Это нужно, чтобы использовать один цикл for для печати и расчета произведения.
             */
